...
public class fileName4 extends ActivityInstrumentationTestCase2<MainMenu>
{
private Solo solo;
...
solo.drag((float)1.1, (float)119.81917,(float)2.2,(float)196.65443,5);

// Drag-TestAction-In-TestState
solo.drag((float)11.1, (float)20.624535,(float)12.2,(float)15.417392,5);
